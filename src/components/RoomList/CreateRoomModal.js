    ...
    return (
        <div className="modal-backdrop">
            <div className="modal-content">
                ...
                <label style={{display: 'block', color: '#4b5563', marginBottom: '0.2rem'}}>방이름</label>
                <input
                    type="text"
                    placeholder="방 이름 입력"
                    value={roomName}
                ...
                />
                <label style={{display: 'block', color: '#4b5563', marginBottom: '0.2rem'}}>닉네임</label>
                <input
                    type="text"
                    placeholder="닉네임 입력"
                    value={nickname}
                    ...
                    onBlur={(e) => (e.target.style.boxShadow = '0 0 0 0 transparent')}
                />
                <label style={{display: 'block', color: '#4b5563', marginBottom: '0.2rem'}}>참여 인원수 (2~10)</label>
                <input
                    type="number"
                ...
                <div className="modal-buttons">
                    ...
                    <button className="create-button"
                            ...
                            style={{
                                ...
                                opacity: !roomName || !nickname || lanes < 2 || lanes > 10 ? 0.5 : 1,
                            }}
